...
//触摸按键长按复位时间配置
// Set to 0: PB1 is the in-ear sensor — continuous ear contact would trigger this hardware reset
// after 8s and restart the IC. Disabled so wearing the earphone never causes a reset.
