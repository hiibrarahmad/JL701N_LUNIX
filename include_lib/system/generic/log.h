...
#define r_printf(x, ...)  do {} while (0)
#define g_printf(x, ...)  do {} while (0)
#define y_printf(x, ...)  do {} while (0)
#define r_f_printf(x, ...)  do {} while (0)
#define g_f_printf(x, ...)  do {} while (0)
#define y_f_printf(x, ...)  do {} while (0)
