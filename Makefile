...
c_SRC_FILES := \
	...
	apps/common/device/gSensor/lis2de12.c \
	...
	cpu/br28/audio_common/audio_dec_codec.c \
...
.PHONY: all clean pre_build rebuild
...
pre_build:
	$(info +PRE-BUILD)
	$(QUITE) $(RM) $(OUT_ELF)
	$(QUITE) find $(BUILD_DIR) -name "*.o" 2>/dev/null | while read obj; do [ ! -f "$${obj%.o}.d" ] && rm -f "$$obj"; done; true
