...
#ifndef TCFG_EARTCH_SWITCH_CFG_ENABLE
#define TCFG_EARTCH_SWITCH_CFG_ENABLE 				1 //入耳消息处理使能开关, 配置项保存到vm, 支持动态开关
#endif
#ifndef TCFG_EARTCH_DEFAULT_EVENT_DEAL_ENABLE
#define TCFG_EARTCH_DEFAULT_EVENT_DEAL_ENABLE      1 //未读到VM配置时的默认开关
#endif
...
#endif /* #if TCFG_EARTCH_SWITCH_CFG_ENABLE */
    {
        log_debug("switch cfg not write, default:%d", TCFG_EARTCH_DEFAULT_EVENT_DEAL_ENABLE);
        __this->eartch_event_deal_en = TCFG_EARTCH_DEFAULT_EVENT_DEAL_ENABLE;
    }
