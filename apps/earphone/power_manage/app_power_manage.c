...
int app_power_event_handler(struct device_event *dev)
{
    ...
    case POWER_EVENT_POWER_WARNING:
        ...
        // If this bud is TWS master and sibling is alive, hand off phone link
        // to sibling now while both buds are still powered. Slave becomes
        // master and keeps audio running when this bud eventually shuts off.
        extern void bt_tws_role_switch(void);
        bt_tws_role_switch();
        break;
