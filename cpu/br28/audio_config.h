...
#define DIG_VOL_MAX_VALUE       (-6.0f)  // JL7016G hybrid: raise music max volume to ANC-safe ceiling
#elif (TCFG_AUDIO_DAC_MODE == DAC_MODE_L_DIFF)
#define DIG_VOL_MAX_VALUE       (-17.0f)  // 数字音量最大值(单位:dB)
